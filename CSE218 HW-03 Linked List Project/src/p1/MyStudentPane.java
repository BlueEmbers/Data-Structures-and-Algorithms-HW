...
public class MyStudentPane extends GridPane{
	...
	public MyStudentPane(StudentStack stack, StudentQueue queue) {
		this.stack = stack;
		this.queue = queue;
		...
		this.push.setOnAction(e -> {
			this.stack.push(new Student(studentName.getText(), Double.parseDouble(studentGpa.getText())));
		...
		this.insert.setOnAction(e -> {
			this.queue.insert(new Student(studentName.getText(), Double.parseDouble(studentGpa.getText())));
			this.studentName.clear();
			this.studentGpa.clear();
		});
		
		this.remove.setOnAction(e -> {
			if((this.queue.getFront() - this.queue.getRear()) == 1) {
